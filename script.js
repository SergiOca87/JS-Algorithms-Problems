...
function sumFibs(num) {
	...
	if (num <= 1) {
		...
		return startingArr
			.filter((currentNum) => currentNum % 2 !== 0 && currentNum <= num)
			.reduce((acc, num) => {
				return acc + num;
			}, 0);
	}
...
/////////////////////////////////////////////////
// Is Valid Walk - Kata
// Given 10 minutes (1 minute per move) and n, s, e, w movements, 
// Can we take a 10 minutes walk and end up at the starting point?
